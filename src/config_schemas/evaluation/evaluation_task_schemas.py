...
from src.config_schemas.evaluation import evaluation_lightning_module_schemas
...
class CommonEvaluationTaskConfig(TarModelEvaluationTaskConfig):
    _target_: str = "src.evaluation.tasks.common_evaluation_task.CommonEvaluationTask"
