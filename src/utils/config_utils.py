...
from src.utils.io_utils import open_file, write_yaml_file

if TYPE_CHECKING:
    from src.config_schemas.config_schema import Config


def get_config(config_path: str, config_name: str, to_object : bool = True, return_dict_config:bool = False) -> TaskFunction:
    setup_config()
    setup_logger()
...
def load_config_header() -> str:
    config_header_path = Path("./src/configs/automatically_generated/full_config_header.yaml")
